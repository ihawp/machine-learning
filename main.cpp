...
)
{
    ...
    arguments.path = "models/" + arguments.directory + "/" + arguments.modelName + ".bin";
...
// ##############################################################################
// Logistic Regression, I think all complete for now good yes!
...
)
{
    ...
    double accuracy = lor.ComputeAccuracy(data.data, data.labels);
